...
data class SearchModsRequest(
    ...
    val sortField: io.wury.terra.cache.curseforge.representation.request.ModsSearchSortField? = null,
    val sortOrder: io.wury.terra.cache.curseforge.representation.request.SortOrder? = null,
    val modLoaderType: io.wury.terra.cache.curseforge.model.game.ModLoaderType? = null,
